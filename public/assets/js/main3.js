        ...
        uniqueDX.forEach(function (unique) {
          {
            ...
            if (arrUnique[2] === "Abnormal") {
              ...
              if (objIndex != -1) {
                let index = listCaseAnswerI.findIndex(
                ...
                if (index == -1) {
                  ...
                  percent = percent / (v + parseFloat(valueM));
                  listCaseIdbyTestId[objIndex]["valueW"] = percent.toFixed(2);
                  listCaseAnswerI[index]["listCase"] +=
                    "Case" +
                    listCaseIdbyTestId[objIndex]["caseId"] +
                    " (" +
                    percent.toFixed(2) +
  ...
  listExportDataFinal.forEach((element) => {
    ...
    if (caseCorrectMin == 0 && listTruebyUser.length > 0) {
      ...
      if (listOutputTrue.length > 0) {
        let listReUseTrue =
          "(Tính theo W USER-TRUE thấp nhất)\n" +
          "Test " +
      ...
      if (listOutputTrue.length > 0) {
        let listReUseTrue =
          "(Tính theo W USER-TRUE cao nhất)\n" +
          "Test " +
          listOutputTrue[0]["testId"] +
          " : ";
        listReUseTrue +=
    ...
    if (caseInCorrectMin == 0 && listFalsebyUser.length > 0) {
      ...
      if (listOutputFalse.length > 0) {
        let listReUseFalse =
          "(Tính theo W USER-FALSE thấp nhất)\n" +
          "Test " +
      ...
      if (listOutputFalse.length > 0) {
        let listReUseFalse =
          "(Tính theo W USER-FALSE cao nhất)\n" +
          "Test " +
          listOutputFalse[0]["testId"] +
          " : ";
        listReUseFalse +=
